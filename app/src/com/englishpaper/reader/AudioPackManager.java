...
public final class AudioPackManager {
    ...
    public JSONObject trialState() {
        ...
        try { o.put("selected", selectedVariant()); for (String v : new String[]{}) o.put(v, isTrialReady(v)); } catch (Exception ignored) { }
        return o;
    }
    ...
    private long trialSize(String variant) { return -1L; }
